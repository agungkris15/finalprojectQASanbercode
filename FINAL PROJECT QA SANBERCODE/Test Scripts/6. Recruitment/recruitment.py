...
class Test1VerifyTheCandidatesSubMenu(unittest.TestCase):
    ...
    def test_tc_searchNameCadidate(self):
        # steps
    ...
    def test_tc_searchCadidate(self):
        # steps
        browser = self.browser # open web browser
        browser.get(url) # open website
        time.sleep(3)
...
class Test2VerifyTheAddCandidatePage(unittest.TestCase):
    ...
    def test_tc_addCandidate(self):
        ...
        browser.find_element(By.ID,"addCandidate_lastName").send_keys("QA Engineer") 
        time.sleep(1)
        ...
        # Successfully saved
        self.assertIn('QA Engineer', validation)
