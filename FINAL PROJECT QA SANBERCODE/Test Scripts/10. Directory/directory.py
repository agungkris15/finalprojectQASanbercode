...
class TestCheckTheSearchDirectorySection(unittest.TestCase):
    ...
    def test_tc_search_unlisted(self):
        # steps
    ...
    def test_tc_search_list_record(self):
        # steps
        browser = self.browser # open web browser
        browser.get(url) # open website
        time.sleep(3)
    ...
    def test_tc_input_directory(self):
        # steps
        browser = self.browser # open web browser
        browser.get(url) # open website
        time.sleep(3)
        ...
        # Test Steps
        # 1. Click Name text box and input Name
        browser.find_element(By.ID,"searchDirectory_emp_name_empName").send_keys("melinda") 
        time.sleep(1)
