...
class TestTheEmployeeListSubMenu(unittest.TestCase):
    ...
    def test_tc_search_employee(self):
        # steps
...
class TestTheAddEmployeePage(unittest.TestCase):
    ...
    def test_tc_addEmployeePIM(self):
        # steps
        browser = self.browser # open web browser
        browser.get(url) # open website
        time.sleep(3)
        ...
        browser.find_element(By.ID,"firstName").send_keys("Jessica") 
        time.sleep(1)
        # 2. Click Last Name text box and input characters
        browser.find_element(By.ID,"lastName").send_keys("Iskandar") 
        time.sleep(1)
        # 3. Click "Save" button
        ...
        # Successfully saved
        self.assertIn('Jessica', validation)
